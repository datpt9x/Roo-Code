		...
		<div
			...
			<div style={{ flex: 1, overflow: "auto", padding: "0 20px" }}>
				<div
					...
					to extend Dmobin Assistant's capabilities. You can use{" "}
					<VSCodeLink href="https://github.com/modelcontextprotocol/servers" style={{ display: "inline" }}>
						community-made servers
					</VSCodeLink>{" "}
					or ask Dmobin Assistant to create new tools specific to your workflow (e.g., "add a tool that gets
					the latest npm docs").
				</div>
					...
					<>
						<div style={{ marginBottom: 15 }}>
							...
							<p
								...
								When enabled, Dmobin Assistant can help you create new MCP servers via commands like
								"add a new tool to...". If you don't need to create MCP servers you can disable this to
								reduce Dmobin Assistant's token usage.
							</p>
						</div>
