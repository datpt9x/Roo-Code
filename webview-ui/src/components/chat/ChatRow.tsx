			...
			case "mistake_limit_reached":
				return [
					...
					<span style={{ color: errorColor, fontWeight: "bold" }}>
						Dmobin Assistant is having trouble...
					</span>,
				]
			case "command":
				return [
					...
					<span style={{ color: normalColor, fontWeight: "bold" }}>
						Dmobin Assistant wants to execute this command:
					</span>,
				]
			case "use_mcp_server":
			...
			case "followup":
				return [
					<span
						...
						style={{ color: normalColor, marginBottom: "-1.5px" }}></span>,
					<span style={{ color: normalColor, fontWeight: "bold" }}>Dmobin Assistant has a question:</span>,
				]
			default:
				return [null, null]
		}
				...
				return (
					<>
						<div style={headerStyle}>
							...
							<span style={{ fontWeight: "bold" }}>Dmobin Assistant wants to edit this file:</span>
						</div>
						<CodeAccordian
			...
			case "newFileCreated":
				return (
					<>
						<div style={headerStyle}>
							{toolIcon("new-file")}
							<span style={{ fontWeight: "bold" }}>Dmobin Assistant wants to create a new file:</span>
						</div>
						<CodeAccordian
							isLoading={message.partial}
							code={tool.content!}
					...
					<>
						<div style={headerStyle}>
							...
							<span style={{ fontWeight: "bold" }}>
								{message.type === "ask"
									? "Dmobin Assistant wants to read this file:"
									: "Dmobin Assistant read this file:"}
							</span>
						</div>
						{/* <CodeAccordian
							code={tool.content!}
				...
				return (
					<>
						<div style={headerStyle}>
							...
							<span style={{ fontWeight: "bold" }}>
								{message.type === "ask"
									? "Dmobin Assistant wants to view the top level files in this directory:"
									: "Dmobin Assistant viewed the top level files in this directory:"}
							</span>
						</div>
						<CodeAccordian
							code={tool.content!}
				...
				return (
					<>
						<div style={headerStyle}>
							...
							<span style={{ fontWeight: "bold" }}>
								{message.type === "ask"
									? "Dmobin Assistant wants to recursively view all files in this directory:"
									: "Dmobin Assistant recursively viewed all files in this directory:"}
							</span>
						</div>
						<CodeAccordian
							code={tool.content!}
				...
				return (
					<>
						<div style={headerStyle}>
							...
							<span style={{ fontWeight: "bold" }}>
								{message.type === "ask"
									? "Dmobin Assistant wants to view source code definition names used in this directory:"
									: "Dmobin Assistant viewed source code definition names used in this directory:"}
							</span>
						</div>
						<CodeAccordian
							code={tool.content!}
					...
					<>
						<div style={headerStyle}>
							...
							<span style={{ fontWeight: "bold" }}>
								{message.type === "ask" ? (
									<>
										Dmobin Assistant wants to search this directory for <code>{tool.regex}</code>:
									</>
								) : (
									<>
										Dmobin Assistant searched this directory for <code>{tool.regex}</code>:
									</>
								)}
							</span>
						</div>
					...
					<>
						<div style={headerStyle}>
							...
							<span style={{ fontWeight: "bold" }}>
								{message.type === "ask" ? (
									<>
										Dmobin Assistant wants to switch to <code>{tool.mode}</code> mode
										{tool.reason ? ` because: ${tool.reason}` : ""}
									</>
								) : (
									<>
										Dmobin Assistant switched to <code>{tool.mode}</code> mode
										{tool.reason ? ` because: ${tool.reason}` : ""}
									</>
								)}
							</span>
				...
				return (
					<>
						<div style={headerStyle}>
							{toolIcon("new-file")}
							<span style={{ fontWeight: "bold" }}>
								Dmobin Assistant wants to create a new task in <code>{tool.mode}</code> mode:
							</span>
						</div>
					...
					return (
						<>
							<div
								...
								<div>
									Dmobin Assistant won't be able to view the command's output. Please update VSCode (
